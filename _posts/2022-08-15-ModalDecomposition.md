...
&[(\sigma_i, f_i, g_i), i = 1, \ldots, k] \; = \; \arg\min \left\Vert \log \left(\frac{P_{\mathsf {xy}}}{P_\mathsf x\cdot P_\mathsf y} \right)- \sum_{i=1}^k \tilde{\sigma}_i \cdot \tilde{f}_i \otimes \tilde{g}_i \right\Vert^2
\end{align}
$$
