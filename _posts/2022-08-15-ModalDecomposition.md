...
We start by defining an _inner product_ in the functional space. Given an alphabet $\mathcal X$, the space of all real-valued functions $\mathca {F_X} = \{f: f: \mathcal X \mapsto \mathbb R\}$ 
