...
The first [colab demo](https://colab.research.google.com/drive/1C9mdtDZ7GFvyiYxEboemJ3Ed18sUMkVB?usp=sharing) is on pytorch implementation of the nested H-score, where we compare the extracted modes with the theoretical results. 
